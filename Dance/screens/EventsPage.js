...
export default class EventsPage extends React.Component {
  ...
  componentDidMount = () => {
    ...
    firebase
      .database()
      .ref("users/" + "292873fbfjfjdbd773838")
      .on("value", snapshot => {
        const highscore = snapshot.val().name;
        console.log("New name: " + highscore);
      });
      */
  };
            ...
            {this.state.events.map(data => (
              <Card key={data.id} style={{ backgroundColor: "#782F40" }}>
                <CardItem header style={{ backgroundColor: "#782F40" }}>
                  ...
                  <Right>
                    <Image
                      style={{ flex: 1, height: 20, width: 60 }}
                ...
                <CardItem style={{ backgroundColor: "#782F40" }}>
                  <Body>
                    <Image
                      style={styles.pic}
                      source={require("../assets/images/cardPic.png")}
                    />
                  </Body>
                </CardItem>
                ...
                <CardItem style={{ backgroundColor: "#cEB888" }}>
                  ...
                  this.state.flagEVENT == data.id ? (
                    ...
                    <Button
                      full
                      dark
                      style={{ width: "100%", backgroundColor: "#782F40" }}
                    ...
                    <View style={styles.modalContainer}>
                      <View style={styles.innerContainer}>
                        <TextInput
                          ...
                          onChangeText={codeEntered =>
                            this.changeText(codeEntered)
                          }
                        />
                        <Button
                          style={{ backgroundColor: "#782F40", top: 10 }}
                          onPress={() => {
                            this.closeModal();
                            if (
                              this.state.codeEntered === this.state.checkCode
                            ) {
                              //updatePoints();
                              ...
                              //if they aren't no points
                                ...
                                console.log(
                                  "Must be in range of event location."
                                );
                              }
